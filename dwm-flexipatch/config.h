...
#if BAR_PANGO_PATCH
static const char font[]                 = "Sourcde Code Pro 10";
#else
...
static char normbordercolor[]            = "#96b0ca";
static char normfloatcolor[]             = "#96b0ca";

static char selfgcolor[]                 = "#eeeeee";
static char selbgcolor[]                 = "#005577";
static char selbordercolor[]             = "#8f848c";
static char selfloatcolor[]              = "#8f848c";
...
{ 0, XF86XK_MonBrightnessDown, spawn, {.v = brdowncmd} },
        { MODKEY, XK_k, spawn, {.v = firefox_cmd}},
	#if KEYMODES_PATCH
